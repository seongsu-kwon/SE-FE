...
import { isSameDateTime } from "@/utils/dateUtils";
  ...
  describe('convertPostInfo', () => {
    it('should convert post detail to desired format', () => {
      const post: PostDetail = {
        ...
        isEditable: true,
        exposeType: 'PUBLIC',
        attachments: { fileMetaDataList: [{ fileMetaDataId: 123, originalFileName: 'file.jpg', storedFileName: 'file-123.jpg', url: 'http://example.com/file-123.jpg' }] },
        isPined: true,
      };
